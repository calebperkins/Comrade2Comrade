...
public class SimpleStage extends StandardStage {
	...
	protected static final long app_id = bamboo.router.Router
			.app_id(SimpleStage.class);
	...
	/**
	 * Constructor <br>
	 * Calling the constructor of our super class, register all events we want
	 * to listen to.<br>
	...
	public SimpleStage() throws Exception {
		...
		event_types = new Class[] { StagesInitializedSignal.class,
				BambooRouteDeliver.class, Alarm.class };
	}
	...
	public void handleEvent(QueueElementIF elem) {
		...
		// Normal operational mode
			...
			if (elem instanceof BambooRouteDeliver) {
				...
				String msg = "This message should be send over"
						+ "Bamboo to the node with the smallest node ID.";
				BambooRouteInit init = new BambooRouteInit(BigInteger.ZERO,
						app_id, false, false, new Payload(msg));
